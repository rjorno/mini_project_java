...
public class Squre extends Geometry implements FlatGeometry {
    ...
    public Squre(Point3D p1, Point3D p2, Point3D p3, Point3D p4){
        triangle1 = new Triangle(p1,p2,p4); //clockwise direction
        triangle2 = new Triangle(p2,p3,p4); //clockwise direction
    }

    public Squre(Squre squre){
        triangle1 = new Triangle(squre.triangle1);
        triangle2 = new Triangle(squre.triangle2);    }
...
// ***************** Getters/Setters ********************** //
    ...
    public Squre(Map<String, String> attributes){
