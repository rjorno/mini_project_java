...
public class Vector implements Comparable<Vector> {
    ...
    public Vector(Vector vector) {this._head = vector._head;}
    ...
    public void normalize() {
        ...
        this.setHead(new Point3D(this.getHead().getX().getCoordinate() / length,
                this.getHead().getY().getCoordinate() / length,
                this.getHead().getZ().getCoordinate() / length));
    }
